...
//        Document doc = XMLbuilder(filePath); 
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 300, 230, -1));
        btnClear.getAccessibleContext().setAccessibleName("Clear Results");
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 561, 320));

        txtFilePath.setEditable(false);
        txtFilePath.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        txtFilePath.setText("Select a database...");
        txtFilePath.setMinimumSize(new java.awt.Dimension(6, 24));
        txtFilePath.setPreferredSize(new java.awt.Dimension(104, 24));
        txtFilePath.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtFilePathActionPerformed(evt);
            }
        });
        jPanel1.add(txtFilePath, new org.netbeans.lib.awtextra.AbsoluteConstraints(581, 270, 150, 23));
        ...
        jPanel1.add(btnFilePath, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 270, 80, -1));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(btnAddClear, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnSearchClear, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
        ...
        jPanel1.add(jTabbedPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 10, 230, 248));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if (txtFilePath.getText().equalsIgnoreCase("Select a database...")) {
            String warn = "Please select a file using the file browser";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (txtFilePath.getText().equalsIgnoreCase("Select a database...")) {
            ...
            if (txtDelID.getText().isEmpty()) {
                String warn = "No ID provided, please try again";
                JOptionPane.showMessageDialog(null, warn);
            }else{
                String filePath = txtFilePath.getText();
                Document doc = XMLbuilder(filePath);
                ...
                List<Student> studentList = XML.XMLsearch(criteria, id, fname, lname, doc);
                 for (Student tempStudent : studentList) {
                     fname = tempStudent.fName;
                     lname = tempStudent.lName;
                }
                XML.XMLdelete(doc, guiid, filePath);
                txtResults.setText(id + " " +  fname + " " +  lname + " has been deleted.");                  
            }
        }
